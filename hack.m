...
%% Go back to the unfiltered dataset...
...
figure
plot(T1,alpha_gyr,'k')
title('Gyroscope-based flexion/extension angle UNFILTERED')
...
figure
plot(T1, alpha_acc)
title('Acceleration-based flexion/extension angle UNFILTERED');
...
figure
plot(T1, alpha_c)
title('Combined angle UNFILTERED')
